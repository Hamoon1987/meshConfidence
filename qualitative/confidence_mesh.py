...
parser.add_argument('--dataset', default='h36m_p1', choices=['h36m_p1', '3dpw', '3doh'], help='Choose  dataset')
parser.add_argument('--img_number', default=0, type=int) # the image number in the dataset that you want to investigate
