...
class Classifier_Dataset(Dataset):
    ...
    def _load_dataset(self):
        ...
        self.label_c = data.iloc[:,16].values
        # Standardize
        sc = StandardScaler()
        ...
        self.label_c = torch.tensor(self.label_c, dtype=torch.float)


    def __getitem__(self, indesp_op):
        return self.sp_op[indesp_op], self.label_c[indesp_op]
...
def fetch_dataloader(data_path, mode):
    ...
    if mode == "test":
        ...
        for (sp_op, label_c) in test_dataloader:
            print('======================================')
        ...
        for (sp_op, label_c) in train_dataloader:
            print('======================================')
            print('Train Dataloader:')
            print(f'  Batch size: {sp_op.shape[0]}')
            ...
            print('======================================')
            break
        for (sp_op, label_c) in val_dataloader:
            print('======================================')
            print('Dataloader:')
            print(f'  Batch size: {sp_op.shape[0]}')
