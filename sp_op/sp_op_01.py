...
Example usage:
```
python3 sp_op/sp_op_01.py --checkpoint=/SPINH/data/model_checkpoint.pt --dataset=3dpw --log_freq=20
```
...
def run_evaluation(model, joint_index, dataset_name, dataset, result_file,
    ...
    for step, batch in enumerate(tqdm(data_loader, desc='Eval', total=len(data_loader))):
        ...
        # # Relative position
        # left_shoulder = pred_keypoints_2d_n[:,9:10,:].clone()
        # left_shoulder = left_shoulder.expand(-1,14,-1)
        # pred_keypoints_2d_n = pred_keypoints_2d_n - left_shoulder
        ...
        # # Relative position
        # left_shoulder = candidate_sorted_t_n[:,9:10,:].clone()
        # left_shoulder = left_shoulder.expand(-1,14,-1)
        # candidate_sorted_t_n = candidate_sorted_t_n - left_shoulder
